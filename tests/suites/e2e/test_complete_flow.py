...
class TestCompleteDataFlow:
    ...
    def test_06_summary_tables_populated(
        ...
        To run extended tests, you must first run the prerequisite tests:
            pytest -k "TestCompleteDataFlow" -v
        
        Or run all E2E tests including extended:
    ...
    def test_07_kruize_experiments_created(
        ...
        Note: This test is marked 'extended' and skipped by default in CI.
        Kruize typically needs multiple data uploads over time to create experiments.
    ...
    def test_08_recommendations_generated(
        ...
        Note: This test is marked 'extended' and skipped by default in CI.
        Kruize typically needs multiple data uploads over time to generate recommendations.
        Run with: pytest -m extended
