...
class DataUploadPhase:
    ...
    def upload_aws_cur_format(self,
        ...
        # Create AWS CUR format CSV data with ALL required columns for parquet processing
        # This includes all columns required by AWSPostProcessor._generate_daily_data()
        csv_data = f"""identity/LineItemId,identity/TimeInterval,bill/BillingEntity,bill/BillType,bill/PayerAccountId,bill/BillingPeriodStartDate,bill/BillingPeriodEndDate,bill/InvoiceId,lineItem/LegalEntity,lineItem/LineItemDescription,lineItem/UsageAccountId,lineItem/LineItemType,lineItem/UsageStartDate,lineItem/UsageEndDate,lineItem/ProductCode,lineItem/UsageType,lineItem/Operation,lineItem/AvailabilityZone,lineItem/ResourceId,lineItem/UsageAmount,lineItem/NormalizationFactor,lineItem/NormalizedUsageAmount,lineItem/CurrencyCode,lineItem/UnblendedRate,lineItem/UnblendedCost,lineItem/BlendedRate,lineItem/BlendedCost,savingsPlan/SavingsPlanEffectiveCost,pricing/publicOnDemandCost,pricing/publicOnDemandRate,pricing/unit,product/ProductName,product/productFamily,product/operatingSystem,product/instanceType,product/region,product/vcpu,product/memory,resourceTags/user:environment,resourceTags/user:app
1,{start_str}T00:00:00Z/{start_str}T01:00:00Z,AWS,Anniversary,123456789012,{start_str}T00:00:00Z,{end_str}T23:59:59Z,INV-12345,Amazon Web Services Inc.,EC2 Instance Usage,123456789012,Usage,{start_str}T00:00:00Z,{start_str}T01:00:00Z,AmazonEC2,BoxUsage:t3.medium,RunInstances,us-east-1a,i-12345,24.0,1.0,24.0,USD,0.0416,1.00,0.0416,1.00,0.00,1.00,0.0416,Hrs,Amazon Elastic Compute Cloud,Compute Instance,Linux,t3.medium,us-east-1,2,4 GiB,production,web-server
2,{start_str}T00:00:00Z/{start_str}T01:00:00Z,AWS,Anniversary,123456789012,{start_str}T00:00:00Z,{end_str}T23:59:59Z,INV-12345,Amazon Web Services Inc.,EC2 Instance Usage,123456789012,Usage,{start_str}T00:00:00Z,{start_str}T01:00:00Z,AmazonEC2,BoxUsage:t3.large,RunInstances,us-east-1b,i-67890,24.0,1.0,24.0,USD,0.0832,2.00,0.0832,2.00,0.00,2.00,0.0832,Hrs,Amazon Elastic Compute Cloud,Compute Instance,Linux,t3.large,us-east-1,2,8 GiB,development,database
3,{start_str}T00:00:00Z/{start_str}T01:00:00Z,AWS,Anniversary,123456789012,{start_str}T00:00:00Z,{end_str}T23:59:59Z,INV-12345,Amazon Web Services Inc.,EBS Volume Usage,123456789012,Usage,{start_str}T00:00:00Z,{start_str}T01:00:00Z,AmazonEC2,EBS:VolumeUsage.gp3,CreateVolume,us-east-1a,vol-12345,100.0,1.0,100.0,USD,0.08,8.00,0.08,8.00,0.00,8.00,0.08,GB-Mo,Amazon Elastic Block Store,Storage,,,us-east-1,,,production,storage
4,{start_str}T00:00:00Z/{start_str}T01:00:00Z,AWS,Anniversary,123456789012,{start_str}T00:00:00Z,{end_str}T23:59:59Z,INV-12345,Amazon Web Services Inc.,EBS Volume Usage,123456789012,Usage,{start_str}T00:00:00Z,{start_str}T01:00:00Z,AmazonEC2,EBS:VolumeUsage.gp3,CreateVolume,us-east-1b,vol-67890,50.0,1.0,50.0,USD,0.08,4.00,0.08,4.00,0.00,4.00,0.08,GB-Mo,Amazon Elastic Block Store,Storage,,,us-east-1,,,development,storage
5,{start_str}T00:00:00Z/{start_str}T01:00:00Z,AWS,Anniversary,123456789012,{start_str}T00:00:00Z,{end_str}T23:59:59Z,INV-12345,Amazon Web Services Inc.,S3 API Requests,123456789012,Usage,{start_str}T00:00:00Z,{start_str}T01:00:00Z,AmazonS3,Requests-Tier1,GetObject,,my-bucket,1000.0,1.0,1000.0,USD,0.0004,0.40,0.0004,0.40,0.00,0.40,0.0004,Requests,Amazon Simple Storage Service,API Request,,,us-east-1,,,production,data
"""
