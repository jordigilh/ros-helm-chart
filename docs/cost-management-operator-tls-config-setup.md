...
ERROR: Post "https://cost-mgmt-ingress-cost-mgmt.apps.cluster.local/api/ingress/v1/upload":
...
spec:
  ...
  upload:
    ...
    ingress_url: "http://cost-mgmt-ingress.cost-mgmt.svc.cluster.local:8080"
...
spec:
  ...
  upload:
    ...
    ingress_url: "https://cost-mgmt-ingress-cost-mgmt.apps.cluster.local"
